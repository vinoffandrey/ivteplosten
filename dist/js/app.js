...
(() => {
  ...
  (() => {
    ...
    window.addEventListener("load", function (e) {
      be(),
        document.querySelector(".works__swiper") &&
          new pe(".works__body", {
            modules: [me, ve, ye],
            effect: "fade",
            observer: !0,
        ...
        document.querySelector(".sertificat__swiper") &&
          new pe(".sertificat__body", {
            modules: [me, ve],
            observer: !0,
            observeParents: !0,
            slidesPerView: 4,
            ...
            breakpoints: {
              320: { slidesPerView: 1, spaceBetween: 10, autoHeight: !0 },
              450: { slidesPerView: 2, spaceBetween: 10 },
              668: { slidesPerView: 3, spaceBetween: 20, slidesPerGroup: 1 },
              991: { slidesPerView: 3, spaceBetween: 15, slidesPerGroup: 1 },
              1068: { slidesPerView: 4, spaceBetween: 20 },
            },
          }),
        document.querySelector(".reviews__swiper") &&
          new pe(".reviews__body", {
            modules: [me, ve, ye],
            effect: "fade",
            observer: !0,
            observeParents: !0,
            ...
            breakpoints: {
              320: { slidesPerView: 1, spaceBetween: 10, autoHeight: !1 },
      ...
      nt = (function () {
        ...
        return (
          ...
          (e.prototype.openGallery = function (e, t) {
            ...
            if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
              ...
              this.zoomFromOrigin &&
                ...
                (o = Ye(t, this.outer, a, l, this.currentImageSize))),
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (m) {
                ...
                C = Je(o, x || "", g, this.settings.strings.playVideo, p);
                n.prepend(C);
              } else if (p) {
          ...
          (e.prototype.closeGallery = function (e) {
            ...
            this.LGel.trigger(Ve), qe(window).scrollTop(this.prevScrollTop);
            var i,
      ...
      vt = (function () {
        function e(e, t) {
          return (
            (this.core = e),
            (this.$LG = t),
            (this.settings = rt(rt({}, at), this.core.settings)),
            this
          );
        }
        return (
          ...
          (e.prototype.init = function () {
            ...
            if (this.settings.zoom) {
              ...
              this.core.outer.on("dblclick.lg", function (t) {
                ...
                this.core.LGel.on(ht + ".zoom", function (t) {
      ...
      $t = (function () {
        function e(e, t) {
          return (
            (this.core = e),
            (this.$LG = t),
            (this.settings = xt(xt({}, zt), this.core.settings)),
            this
          );
        }
        return (
          ...
          (e.prototype.init = function () {
            ...
            this.settings.rotate &&
              ...
              this.core.LGel.on(Tt + ".rotate", function (t) {
    ...
    const Mt = $t,
      Pt = document.querySelectorAll("[data-gallery]");
    Pt.length &&
      Pt.forEach((e) => {
    ...
    (Vt.prototype._setActiveClass = function () {
      var e, t, i, s;
      ...
      if (o.length)
        if (this._config.loop)
          for (e = 0, t = o.length; e < t; e++) o[e].classList.add(kt);
        else
          0 === this._currentIndex
            ? (o[0].classList.remove(kt), o[1].classList.add(kt))
            : this._currentIndex === this._$itemList.length - 1
            ? (o[0].classList.add(kt), o[1].classList.remove(kt))
            : (o[0].classList.add(kt), o[1].classList.add(kt));
    }),
      (Vt.prototype._move = function () {
      ...
      (Vt.prototype._refreshExtremeValues = function () {
      ...
      (Vt.prototype._balancingItems = function () {
      ...
      (Vt.prototype._addEventListener = function () {
        var e = this._$items;
        function t(e) {
          this._autoplay("stop");
      ...
      (Vt.prototype.autoplay = function (e) {
        this._autoplay("stop");
      });
    ...
    const Ht = document.querySelectorAll(".card-preview-slider");
    Ht.length > 0 &&
      (s.any()
        ? Ht.forEach((e) => {
